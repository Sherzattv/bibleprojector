...
- Адаптивные выдвижные панели v3 для планшетов и телефонов.

### Changed
- CI проверяет обе линии приложения и запускает те же команды Svelte/TypeScript,
  что используются локально.
- v3 имеет предварительную версию `3.0.0-preview.1`; стабильным релизом
  остаётся 2.2.0.
